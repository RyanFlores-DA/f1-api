...
class MarshalZoneParser extends f1_parser_1.F1Parser {
    constructor() {
        super();
...
class WeatherForecastSampleParser extends f1_parser_1.F1Parser {
    constructor() {
        super();
...
*/
class PacketSessionDataParser extends f1_parser_1.F1Parser {
    constructor(buffer) {
        super();
        this.endianess('little')
            .nest('m_header', {
